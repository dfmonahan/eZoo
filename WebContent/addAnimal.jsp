	...
	<div class="container">
		...
		<form action="addAnimal" method="post" class="form-horizontal">
			...
			<div class="form-group">
				<label for="animalid" class="col-sm-4 control-label">ID</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<select required="required" name="healthStatus"
						class="form-control">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<select required="required" name="type" class="form-control">
						<option value="Mammal (Terrestrial)">Mammal (Terrestrial)
						</option>
						<option value="Mammal (Aquatic)">Mammal (Aquatic)</option>
						<option value="Mammal (Aviary)">Mammal (Aviary)</option>
			...
			<div class="form-group">
				<label for="height" class="col-sm-4 control-label">Height
					(in)</label>
				<div class="col-sm-4">
					<input type="number" step="0.01" class="form-control" id="height"
						name="height" placeholder="Height" required="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="number" step="0.01" class="form-control" id="weight"
						name="weight" placeholder="Weight" required="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="kingdom" name="kingdom"
						placeholder="Kingdom" required="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="phylum" name="phylum"
						placeholder="Phylum" required="required" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="order" name="order"
						placeholder="Order" required="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="family" name="family"
						placeholder="Family" required="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="genus" name="genus"
						placeholder="Genus" required="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="species" name="species"
						placeholder="Species" required="required" />
				</div>
			</div>
			<div class="form-group">
				<label for="schedule_id" class="col-sm-4 control-label">Feeding schedule</label>
				<div class="col-sm-4">
